...
pub fn cal_enum_status(atca_status: cryptoauthlib_sys::ATCA_STATUS) -> super::AtcaStatus {
    return match atca_status {
        ...
        cryptoauthlib_sys::ATCA_STATUS_ATCA_CONFIG_ZONE_LOCKED => super::AtcaStatus::AtcaConfigZoneLocked,
        cryptoauthlib_sys::ATCA_STATUS_ATCA_DATA_ZONE_LOCKED => super::AtcaStatus::AtcaDataZoneLocked,
        cryptoauthlib_sys::ATCA_STATUS_ATCA_WAKE_FAILED => super::AtcaStatus::AtcaWakeFailed,
        cryptoauthlib_sys::ATCA_STATUS_ATCA_CHECKMAC_VERIFY_FAILED => super::AtcaStatus::AtcaCheckMacVerifyFailed,
        ...
        cryptoauthlib_sys::ATCA_STATUS_ATCA_STATUS_SELFTEST_ERROR => super::AtcaStatus::AtcaStatusSelftestError,
        ...
        cryptoauthlib_sys::ATCA_STATUS_ATCA_RESYNC_WITH_WAKEUP => super::AtcaStatus::AtcaResyncWithWakeup,
        ...
        cryptoauthlib_sys::ATCA_STATUS_ATCA_TOO_MANY_COMM_RETRIES => super::AtcaStatus::AtcaTooManyCommRetries,
        ...
        cryptoauthlib_sys::ATCA_STATUS_ATCA_EXECUTION_ERROR => super::AtcaStatus::AtcaExecutionError,
        ...
        cryptoauthlib_sys::ATCA_STATUS_ATCA_HEALTH_TEST_ERROR => super::AtcaStatus::AtcaHealthTestError,
        cryptoauthlib_sys::ATCA_STATUS_ATCA_ALLOC_FAILURE => super::AtcaStatus::AtcaAllocFailure,
        cryptoauthlib_sys::ATCA_STATUS_ATCA_USE_FLAGS_CONSUMED => super::AtcaStatus::AtcaUseFlagsConsumed,
